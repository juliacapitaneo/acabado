...
function setup() {
  ...
  plane = Bodies.rectangle(200, 600, 100, 50, plane_options);
  World.add(world, plane);

  //crie corpo block1 e adicione ao mundo
  block1 = Bodies.rectangle(400, 400, 10, 10, plane_options);
  ...
  rotate1 = Bodies.rectangle(250, 200, 400, 20, rotator_options);
  World.add(world, rotate1);

  //crie rotator2 e adicione ao mundo
  rotate2 = Bodies.rectangle(250, 200, 400, 20, rotator_options);
  World.add(world, rotate2);

  //crie rotator3 e adicione ao mundo
  rotate3 = Bodies.rectangle(250, 200, 400, 20, rotator_options);
